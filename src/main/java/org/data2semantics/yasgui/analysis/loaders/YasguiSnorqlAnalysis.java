...
public class YasguiSnorqlAnalysis extends AnalysisSetup {
	...
	public YasguiSnorqlAnalysis() throws IOException {
		...
		this.inputTypes = new Input[]{AnalysisSetup.Input.YASGUI_NEW};//only new queries: they are the only ones containing this feature. additionally we can link the queries to the dbpedia endpoint this way
